...
- BERTText.py파일을 참고하셔도 무방합니다, 대략적으로 BERT에 어떤 모델들이 있는지 예시를 들어 수록해 놓은 코드가 있습니다(해당 url링크 첨부)
- 계속해서 업데이트가 이루어지고 있는 부분입니다, 따라서 다른 여러 내용이 추가될 수 있음을 미리 안내드립니다.
...
- 아 참, 마지막에 올린 부분은 다국어 지원을 위한 파일입니다.
